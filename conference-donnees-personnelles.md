...
Instagram
----------
Instagram enregistre [toutes les interactions](https://www.instagram.com/your_activity/interactions/likes/) que vous avez avec d'autres comptes : commentaires, likes, réponses aux stories.
</section>
<section data-markdown>
Instagram
----------
Si vous avez autorisé Instagram à vous suggérer des amis, [vous avez probablement uploadé tout votre carnet d'adresse sur la plateforme](https://www.instagram.com/accounts/contact_history/?__coig_login=1).
</section>
<section data-markdown>
### Au-delà de la vie privée
[Les  facebook files](https://www.wsj.com/articles/the-facebook-files-11631713039) révèlent (entre autres) que Meta a constaté qu'Instagram était néfaste pour ses utilisateurs, en particulier les adolescentes. En public, Meta a toujours minimisé les effets négatifs de l'application et n'a pas rendu ses recherches publiques ou accessibles aux universitaires ou aux législateurs qui en ont fait la demande.
</section>
<section data-markdown>
### Au-delà de la vie privée
la nouvelle fonctionnalité de Tiktok [Focused view](https://www.accessnow.org/tiktok-focused-view/) propose aux annonceurs une option "payer si les utilisateurs s'engagent", permet d'atteindre les abonnés de la plateforme qui "prêtent vraiment attention" et "s'engagent de manière émotionnelle et tangible".
</section>
</section>
...
<section>
<ul>
<li class="fragment">Dans ce contexte, oubliez la navigation privée dans <a href="https://support.mozilla.org/fr/kb/navigation-privee-naviguer-sans-conserver-infos-sites">Firefox</a>
 ou <a href="https://support.google.com/chrome/answer/95464?hl-fr">Chrome</a>
  qui n'a en fait pas grand chose de privé...</li>
<li class="fragment"><a href="https://disconnect.me/">Disconnect</a>
, <a href="https://www.eff.org/fr/privacybadger">Privacy Badger</a>
 ou <a href="https://noscript.net/">Noscript</a>
 . Oui mais...</li>
<li class="fragment"><a href="https://noscript.net/">L'erreur est humaine</a>
. Et si ce n'est pas vous qui lâchez des informations, vos "amis" le feront pour vous.</li>
</ul>
</section>
<section data-markdown>
### Ne pas avoir de compte de réseaux sociaux
</section>
<section>
...
<section data-markdown>
### En résumé
* Une approche individuelle. Sauf que contre Google ou Facebook/Meta, **seul on perd à tous les coups**
